...
no longer be usable.'); ?>"></span> to your website & write us about your issue.</p>
                    ...
                    <?php $dev_act_btn_txt = __('Grant Temporary Access to Developers'); ?>
                    
                    <div class="after-regi-btn">
                    
                        <span class="access-buttons">
                            <button class="button updater-act-btn btn-dev-access" id="developer-access">
		...
		jQuery.ajax(
			{
				...
				success: function(result){
					...
					if(result == "Access Revoked!"){
						var buttons = '<button class="button updater-act-btn btn-dev-access" id="developer-access"><span class="dashicons dashicons-admin-network"></span><?php echo $dev_act_btn_txt; ?></button>';
						jQuery(".access-buttons").html(buttons);
