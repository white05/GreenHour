(function() {
    tinymce.PluginManager.add('essgrid_sc_button', function( editor, url ) {
		 ...
		 **/
		jQuery('#ess-grid-add-custom-shortcode, #ess-grid-add-custom-shortcode-special').click(function(e){
			...
			if(jQuery(this).attr('id') == 'ess-grid-add-custom-shortcode'){
				...
				layers = JSON.stringify(layers).replace(/\[/g, '({').replace(/\]/g, '})');
			...
			if(!ess_grid_is_vc){
				...
				jQuery('input[name="esg-vc-shortcode-content"]').val(content);
				jQuery('#ess-grid-tiny-mce-dialog').dialog('close');
				jQuery('.wpb_save_edit_form').click();
		 ...
		 **/
		jQuery('#eg-add-predefined-grid').click(function(e){
			var form = jQuery(this).parents('form');
			if ( ! validateForm( form ) )
				return false;
		 ...
		 **/
		jQuery('.eg-add-custom-element').click(function(e){
		...
		jQuery('#eg-goto-step-2').click(function(){
		...
		jQuery('#eg-create-custom-grid').click(function(){
			esg_create_by_predefined = false;
			jQuery('#eg-goto-step-2').click();
		});
		
		jQuery('#eg-edit-custom-grid').click(function(){
			esg_create_by_predefined = false;
			jQuery('#ess-grid-tiny-dialog-step-1').hide();
		...
		jQuery('#eg-create-popularpost-grid').click(function(){
			esg_create_by_predefined = 'popular';
			jQuery('#eg-goto-step-2').click();
		});
		
		jQuery('#eg-create-recentpost-grid').click(function(){
			esg_create_by_predefined = 'recent';
			jQuery('#eg-goto-step-2').click();
		});
		
		jQuery('#eg-create-relatedpost-grid').click(function(){
		 ...
		 * Go to step 1
		 **/
		jQuery('#eg-goto-step-1, #eg-goto-step-1-5').click(function(){
			jQuery('#ess-grid-tiny-dialog-step-1').show();
			jQuery('#ess-grid-tiny-dialog-step-2').hide();
			jQuery('#ess-grid-tiny-dialog-step-2-5').hide();
			jQuery('#ess-grid-tiny-dialog-step-3').hide();
		 ...
		 * Go to step 3
		 **/
		jQuery('#eg-goto-step-3').click(function(){
			jQuery('#ess-grid-tiny-dialog-step-1').hide();
			jQuery('#ess-grid-tiny-dialog-step-2').hide();
			jQuery('#ess-grid-tiny-dialog-step-2-5').hide();
		...
		jQuery('select[name="ess-grid-tiny-entry-skin"]').change(function(){
		...
		jQuery('select[name="ess-grid-tiny-grid-layout"]').change(function(){
		...
		jQuery('select[name="ess-grid-tiny-existing-settings"]').change(function(){
