...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button button secondary round"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <i class="ub-icon-arrow-down4"></i></a></h2>
	...
	<div class="shipping_calculator_note">
		<span class="arrow-shape-up"></span>
		<p><?php _e('Click here to calculate shipping fee, based on your location or shipping address.', 'une_boutique') ?></p>
	</div>
</form>
