        ...
        <div id="<?php echo $carousel_id ?>" data-ride="capital-posts-carousel" data-wrap="<?php echo $wrap==='yes' ? 'true' : 'false' ?>" data-interval="<?php echo $autoplay == 'yes' ? $speed : 0 ?>" data-auto-height="true" data-mode="<?php echo $mode ?>" data-partial="<?php echo $partial_view === 'yes' ? 'true' : 'false' ?>" data-per-view="<?php echo $slides_per_view ?>" data-hide-on-end="<?php echo $autoplay == 'yes' ? 'false' : 'true' ?>" class="vc-carousel vc-slide">
            ...
            <div class="capital-posts-carousel-inner">
                ...
                $block_style = isset($post->bgcolor) ? ' style="background-color: '.$post->bgcolor.'"' : '';
                    ?>
                <div class="post-slide-item vc_slide_<?php echo $post->post_type ?>"<?php echo $block_style ?>>
            ...
            <script>
                jQuery(document).ready(function($){"use strict";
                    $(".capital-posts-carousel-slideline-inner").owlCarousel({
