...
<div class="<?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base']) ?>">
    <div class="wpb_wrapper">
        ...
        <div id="<?php echo $carousel_id ?>" class="vc-slide vc-carousel">
            <!-- Wrapper for slides -->
            <div class="vc-carousel-inner">
                <div class="vc-carousel-slideline"><div class="vc-carousel-slideline-inner">
                    ...
                    <?php if ($onclick == 'link_image'): ?>
                        ...
                        <a class="ilightbox" href="<?php echo $p_img_large[0]; ?>">
                            <?php echo $thumbnail; ?>
                        </a>
            ...
            <script>
                jQuery(document).ready(function($){"use strict";
                    $("#<?php echo $carousel_id ?> .vc-carousel-slideline-inner").owlCarousel({
                    autoPlay: <?php echo $autoplay == 'yes' ? $speed : 'false' ?>,
                    items : <?php echo $slides_per_view ?>,
                    <?php if($hide_prev_next_buttons !== 'yes') { ?>
                        navigation:true,
                        navigationText:["<i class=\'ub-icon-arrow-left6\'></i>","<i class=\'ub-icon-arrow-right6\'></i>"],
                    <?php } else { ?>
                        navigation:false,
                    <?php } ?>
