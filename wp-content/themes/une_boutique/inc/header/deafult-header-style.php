...
<nav id="site-navigation" class="<?php if (ot_get_option('sticky_navigation_bar')  == 'on'  ){echo 'stickUp';} ?>"> <!-- main navigation section -->
	...
	<div class="row relative">
		<div class="small-1 start-here-column columns">
		...
		<div class="top-bar small-4 large-10 columns large-centered" role="navigation">
		...
		<div id="collapsable-search-form">
			<div class="small-1 columns alignright no-margin-left">
